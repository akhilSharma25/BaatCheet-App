...
// const acceptedRequests = friendRequests?.acceptReq || [];
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-4">
                  {incomingRequests.map((request) => (
                    <div
                      key={request._id}
                      className="card bg-base-200 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300"
                    >
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                          className={`btn btn-primary btn-sm flex items-center gap-2 ${
                            isPending ? "opacity-50 cursor-not-allowed" : "hover:bg-primary-focus"
                          }`}
                          onClick={() => acceptRequestMutation(request._id)}
                          disabled={isPending}
                        >
                  ...
                  {acceptedRequests.map((notification) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="badge badge-success badge-sm flex items-center gap-1">
